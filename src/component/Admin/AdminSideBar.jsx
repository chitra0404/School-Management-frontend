      ...
      <div className="row vh-100 flex-wrap">
        <div className=" col-md-6 h-100 bg-dark ">
          ...
          <div className="d-flex flex-column align-items-center align-items text-white min-vh-100">
            <Link to="/admin" className="d-flex align-items-center  me-md-auto text-white text-decoration-none">
              <span className="fs-5 d-none d-sm-inline">Menu</span>
            </Link>
            <ul className="nav nav-pills flex-column  mb-0 align-items-center align-items-sm-start" id="menu">
              <li className="nav-item">
                <Link to="/admin/card" className="nav-link align-middle text-white px-0">
                  <i className="fs-4 bi-house"></i> <span className="ms-1 d-none d-sm-inline">Home</span>
                </Link>
              </li>
              <li>
                <Link to="/admin/addteacher" className="nav-link px-0 text-white align-middle">
                  <i className="fs-4 bi-house"></i> <span className="ms-1 d-none d-sm-inline">Add Teacher</span>
                </Link>
              </li>
              <li>
                <Link to="/admin/addstudent" className="nav-link px-0 text-white align-middle">
                  <i className="fs-4 bi-house"></i> <span className="ms-1 d-none d-sm-inline">Add Student</span>
                </Link>
              </li>
              <li>
             
                <Link to="/admin/addnotice" className="nav-link px-0 text-white align-middle">
             ...
             <Link to="/admin/getclass" className="nav-link px-0 text-white align-middle">
             ...
             <Link to="/admin/sub" className="nav-link px-0 text-white align-middle">
